      ...
      <div className="topbar border-b border-gray-800">
        <ul>
          <li>
            ...
            <span className="text-2xl max-sm:text-lg text-accent-content">+91 4204209211</span>
          </li>
          <li>
            <FaRegEnvelope className="text-2xl max-sm:text-lg text-accent-content" />{" "}
            <span className="text-2xl max-sm:text-lg text-accent-content">quarkum@check.com</span>
          </li>
        </ul>
      </div>
